package id.billboard.utero.uterobillboard.adapter;
...
import id.billboard.utero.uterobillboard.R;
...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.galery_list, parent, false);
